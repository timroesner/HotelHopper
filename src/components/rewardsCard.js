...
class RewardsCard extends Component {
  render() {
    return (
      <div className="bg-soft-blue rounded-lg md:rounded-xl md:max-w-xl mx-auto text-white font-sans font-bold h-28 md:h-64">
        <div className="flex items-flex justify-center">
          <div className="w-3/5 md:h-64 ml-2 md:ml-4">
            <div className="mt-2 md:mt-6">
              <p className="text-sm md:text-2xl">Hotel Hopper</p>
              <p className="text-base md:text-3xl">Rewards Program</p>
            </div>
            <p className="text-xs md:text-2xl mt-4 md:mt-8 opacity-75">
              These points can be redeemed for a free stay. You earn them by staying with us.
            </p>
          </div>
          <div className="mt-4 md:mt-8 md:pl-6 md:h-64">
